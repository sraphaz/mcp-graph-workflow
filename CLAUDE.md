...
src/
  ...
  mcp/tools/         # MCP tool wrappers (46 tools + 6 deprecated)
...
| 46 MCP Tools + 6 deprecated | mcp/tools/ | [MCP Tools Reference](docs/reference/MCP-TOOLS-REFERENCE.md) |
...
8. **LISTENING** — Feedback, novo ciclo
