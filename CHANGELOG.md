...
## [10.0.2](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/compare/mcp-graph-v10.0.1...mcp-graph-v10.0.2) (2026-04-19)


### Bug Fixes

* **ci:** trigger license-headers on package.json so release PRs unblock ([#202](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/issues/202)) ([73baec1](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/73baec18c5b26da93a278d90e99c9b39f31ea86e))
...
* Multi-Terminal Orchestrator — teamTask mode for parallel agent coordination ([13a253d](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/13a253df35df29c5cbac4f3894acaa5b536ef712))
* multi-terminal orchestrator Phase 2+3 — event bridge, orphan detector, heartbeat ([cd8aabb](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/cd8aabb5b817c8ba0475d52752dca7bbb5e62546))

## [9.0.0](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/compare/mcp-graph-v8.0.0...mcp-graph-v9.0.0) (2026-04-13)
...
* Add dashboard UX overhaul, hybrid RAG scoring, and harness engineering ([819f79d](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/819f79de10a2eea2335ec0b6349ccb188e8383bf))
...
* add feature-depth analyzer v2.0 — 7 mathematical frameworks for depth analysis ([51766c3](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/51766c32d816e7e2824341cbeab7eb06f0c58207))
...
* auto-promote epics + cascade status propagation ([23aef3f](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/23aef3fcac3ebf8a089847b5a61690b5276f0c6d))
...
* Grade AAA+ Phase 1 — ONNX embeddings, hybrid search, multi-agent foundations (7/18 tasks) ([0b51ef6](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/0b51ef6ac0cbc07096d4e64f00b5d1aa084168ee))
...
* Harness Engineering v4 — Deterministic Remediation Engine + Full Feedback Loop ([cb284bf](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/cb284bfe6a425070bbcc131b3bca804da45621bf))
...
* NLP engine quality — unified tokenizer, stemming, fuzzy search ([e3e479a](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/e3e479ad5a7c510ecd74f3ca724f421a47c80862))
...
* Spec-Driven Development platform — port spec-kit features to mcp-graph ([23dd0e8](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/23dd0e8a42881cb9959f48d8c43ffc5b16d13374))
...
* v7.0 consolidation — remove deprecated tools, add unified gate and graph health ([b198af8](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/b198af83270e6e3aabee9832e56c8a088843fd79))
* v8.0 tool consolidation — 21 tools merged into 5 unified action-based tools ([44357ca](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/44357ca3dcc543b59f488222af3dde742e9d660a))
* v8.0.0 release — tool consolidation, spec-driven development, NLP engine, analytics API ([bf2a791](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/bf2a79120c4cf8034325939d556f12303a3b6a86))
...
* add defensive assertion in api-skills test for parallel stability ([872c3ef](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/872c3ef145b371676683360eec88759936e43f47))
...
* **benchmark:** correct token savings baseline and redesign tab UX ([e74222d](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/e74222d719c201ff5fb624ac38994d57b3d3305e))
...
* **mcp:** persist metadata fields on node update action ([af30564](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/af30564159a9d0c953ab618da5c96a42e0ee8ccd))
...
* normalize testFiles paths in graph-sync and add contextEnrichment metric ([a8d56df](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/a8d56dfa2d0e8b64411824e0cc6fcd26b93145b7))
...
* relax tokenizer SLO threshold from 5ms to 20ms for CI stability ([916373f](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/916373f9e9f5cdbde5bce8a49be6a9519066a083))
...
* repair release pipeline — manual publish workflow, lighter pre-push hook ([50349ac](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/50349ac2071d6a8e4fa5cc548dad62e56b0b94a1))
...
* update exportedAt timestamp in knowledge-export.json and correct image source in README.md ([e925b89](https://github.com/DiegoNogueiraDev/mcp-graph-workflow/commit/e925b897556519aaac222b79e859caa816f7226c))
