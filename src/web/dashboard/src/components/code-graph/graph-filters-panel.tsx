          ...
          {NODE_KINDS.map((kind) => {
            ...
            return (
              <button
                ...
                className="w-full flex items-center gap-2 px-2 py-1 rounded text-xs hover:bg-surface-elevated transition-colors"
              >
                <span
                  className="w-2.5 h-2.5 rounded-full shrink-0"
                  style={{ background: visible ? color : "#333" }}
                />
                <span className={visible ? "" : "text-muted line-through"}>
            ...
            <button
              ...
              className={`text-[10px] px-2.5 py-1 rounded transition-colors ${
                focusDepth === opt.value
                  ...
                  : "bg-surface-elevated text-muted hover:bg-surface"
              }`}
            >
              {opt.label}
            </button>
